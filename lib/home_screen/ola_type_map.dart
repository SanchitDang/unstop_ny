                      ...
                      Expanded(
                        child: Card(
                          ...
                          child: Padding(
                            ...
                            child: Row(
                              children: const [
                                Icon(Icons.arrow_right_alt, color: Color.fromRGBO(168,142,60,1)),
                                SizedBox(width: 15),
                                Text('Where to?', style: TextStyle(color: Color.fromRGBO(168,142,60,1), fontSize: 16, fontWeight: FontWeight.w500)),
                              ],
                            ),
                          ),
                        ),
                          ...
                          child: Padding(
                            ...
                            child: Row(
                              children: const [
                                Icon(Icons.history),
                                SizedBox(width: 15),
                                Text('UB City, KG Halli', style: TextStyle(fontSize: 16, fontWeight: FontWeight.w500)),
                                Spacer(),
